#!/usr/bin/env python
"""ETFH-ExtractTextsFromHtml: extract all the sentences within paragraph from HTML file."""
__version__ = "1.0"
__author__ = "Wesagn Dawit (wessi@icog-labs.com)"
__copyright__ = "iCog-Laws"
__contributors__ = ["Natnael Argaw", "Selameab"]
...
class HTML2Text(HTMLParser.HTMLParser):
    ...
    def handle_tag(self, tag, attrs, start):
        ...
        # append strings only within the tag <p> to the output text   
        if tag != "p":
            self.quiet = 1 # sites like 9rules.com never close <head>
        else: self.quiet = 0
        # if tag != "body":
        #     self.quiet = 1 # sites like 9rules.com never close <head>
        # else: self.quiet = 0
